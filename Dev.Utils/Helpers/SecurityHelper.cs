...
namespace Dev.Utils.Helpers
{
    public static class SecurityHelper
    {
        ...
        //    var encoding = Encoding.UTF8;
        //    byte[] keyStr = encoding.GetBytes(keyVal);
        //    MD160 hmacRipeMd160 = new RIPEMD160(keyStr);
        ...
        /// <returns></returns>  
        public static string AesEncrypt(this string value, string keyVal, string ivVal)
        {
            if (value == null)
            {
                throw new ArgumentNullException("value");
        ...
        /// <param name="ivVal">加密辅助向量</param>  
        /// <returns></returns>  
        public static string AesDecrypt(this string value, string keyVal, string ivVal)
        {
            var encoding = Encoding.UTF8;
            byte[] btKey = keyVal.FormatByte(encoding);
            byte[] btIv = ivVal.FormatByte(encoding);
        ...
        /// <param name="ivVal">加密辅助向量</param>  
        /// <returns></returns>  
        public static byte[] AesByteEncrypt(this byte[] data, string keyVal, string ivVal)
        {
        ...
        /// <param name="ivVal">加密辅助向量</param> 
        /// <returns></returns>  
        public static byte[] AesByteDecrypt(this byte[] data, string keyVal, string ivVal)
        {
            byte[] bKey = new byte[32];
            Array.Copy(Encoding.UTF8.GetBytes(keyVal.PadRight(bKey.Length)), bKey, bKey.Length);
            byte[] bVector = new byte[16];
        ...
        /// DES 加密
        /// </summary>
        public static string DesEncrypt(this string value, string keyVal, string ivVal)
        {
        ...
        /// DES 解密
        /// </summary>
        public static string DesDecrypt(this string value, string keyVal, string ivVal)
        {
